...
export default function Experience() {
  ...
  return (
    <div className="mt-8 /pl-5 /pr-4 /pt-9 pb-16 text-sm rounded-lg /bg-zinc-200 /border border-zinc-300 text-black  dark:text-zinc-200 /dark:bg-zinc-900 dark:border-zinc-700">
      <h2 className="text-[1.75rem] mb-2 font-medium dark:text-white">
        Experience
      </h2>
      <div className="mt-16 flex justify-center">
        ...
        <div className="relative pl-8 flex justify-end">
            ...
            <div className="max-w-md grow px-4 pt-5 pb-3 rounded-md bg-zinc-200 border border-zinc-300 dark:bg-zinc-900 dark:border-zinc-700">
              ...
              <p className="dark:text-zinc-300">Full Stack Developer</p>
          ...
          <div className="relative pl-8 flex justify-end">
            ...
            <div className="max-w-md grow px-4 pt-5 pb-3 mt-7 rounded-md bg-zinc-200 border border-zinc-300 dark:bg-zinc-900 dark:border-zinc-700">
              ...
              <p className="dark:text-zinc-300">Frontend Developer</p>
              <div className="mt-5 flex items-start">
                <Image
                  src={
                    theme === "light"
          ...
          <div className="relative pl-8 flex justify-end">
            ...
            <div className="max-w-md grow px-4 pt-5 pb-3 mt-7 rounded-md bg-zinc-200 border border-zinc-300 dark:bg-zinc-900 dark:border-zinc-700">
              ...
              <p className="dark:text-zinc-300">Software Engineer Intern</p>
              <div className="mt-5 flex items-start">
                <Image
                  src={
                    theme === "light"
          ...
          <div className="relative pl-8 flex justify-end">
            ...
            <div className="max-w-md grow px-4 pt-5 pb-3 mt-7 rounded-md bg-zinc-200 border border-zinc-300 dark:bg-zinc-900 dark:border-zinc-700">
              ...
              <p className="dark:text-zinc-300">Frontend Developer Intern</p>
              <div className="mt-5 flex items-start">
                <Image
                  src={
                    theme === "light"
